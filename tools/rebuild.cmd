...
cl %CF% /c %SRC%\main.cpp %SRC%\wasapi_process_capture.cpp %SRC%\wasapi_endpoint_capture.cpp %SRC%\volume_map.cpp %SRC%\asio_render.cpp %SRC%\wasapi_output.cpp %SRC%\device_scan.cpp %SRC%\web_console.cpp %SRC%\update_check.cpp %ASIO%\common\asio.cpp %ASIO%\host\pc\asiolist.cpp /Fo:build/obj/
