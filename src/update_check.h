...
//   备源：内置 GitHub Releases API（海外/通用可达，本机 DNS 污染时也能用）
//   检查顺序：先主源，WinHTTP 不可达/解析失败 → 自动改拉 GitHub 备源。
...
// 软件当前版本（打包/发布时同步修改）
static const char* kAppVersion = "1.0.6";
